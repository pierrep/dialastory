...
class Arduino(object):
    ...
    # here is where we are gonna get dicy and modify the lib
    # we will let the keypad have a go with the method readKey
    def readKey(self):
        self.__sendData('5')
        return self.__getData()

    def readHandsetLifted(self):
        return self.getState(44)
